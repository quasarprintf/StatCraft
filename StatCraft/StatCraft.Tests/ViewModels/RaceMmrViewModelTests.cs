...
public class RaceMmrViewModelTests
{
    ...
    public void NoSessionBaseline_ShowsRatingOnly()
    {
        ...
        RaceMmrViewModel vm = new(LadderRace.P, 5239, null);
    ...
    {
        RaceMmrViewModel vm = new(LadderRace.P, 5239, 5239);
    ...
    {
        RaceMmrViewModel vm = new(LadderRace.P, 5263, 5239);
    ...
    {
        RaceMmrViewModel vm = new(LadderRace.Z, 4076, 4100);
    ...
    public void DeltaAccumulatesAcrossSession_NotJustTheLastGame()
    {
        ...
        RaceMmrViewModel afterThree = new(LadderRace.T, 4180, 4100);
    ...
    [Theory]
    [InlineData(LadderRace.P)]
    [InlineData(LadderRace.T)]
    [InlineData(LadderRace.Z)]
    [InlineData(LadderRace.R)]
