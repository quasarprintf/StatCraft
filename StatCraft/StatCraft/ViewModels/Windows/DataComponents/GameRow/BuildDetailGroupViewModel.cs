...
public sealed class BuildDetailGroupViewModel(string buildName, int depth, ObservableCollection<AttributeValue> values)
{
    ...
    public ObservableCollection<AttributeValue> Values { get; } = values;
}
